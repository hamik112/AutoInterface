...
class DeviceSearch:
    def __init__(self):
        self.target_name = 'ODBII'
        
    def setTargetName(self, Target):
    ...
    def getAllAddresses(self):
        ...
        nearby_devices = bluetooth.discover_devices()
        for bdaddr in nearby_devices:
            DeviceName = bluetooth.lookup_name( bdaddr )
            if(DeviceName in dic):
                dic[DeviceName].append(bdaddr)
            else:
                dic[DeviceName]=[bdaddr]
        return dic
